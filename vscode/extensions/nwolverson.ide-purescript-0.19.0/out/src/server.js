  ...
  var completionItem = function (label) {
      return function (k) {
          return Data_Newtype.over(newtypeCompletionItem)(newtypeCompletionItem)(CompletionItem)(function (v) {
              ...
              $53.kind = Data_Nullable.toNullable(Data_Maybe.Just.create(completionItemKindToInt(k)));
              return $53;
      ...
      return function (version) {
          return function (oldText) {
              return function (newText) {
                  ...
                  return e(range(oldLines)(0)(0))("third case " + (Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(firstDiff) + (" , " + (Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(lastDiff) + (" , " + (Data_Show.show(Data_Show.showInt)(Data_Array.length(oldLines)) + (" , " + Data_Show.show(Data_Show.showInt)(Data_Array.length(newLines)))))))));
              };
          };
      };
  };
              ...
              return function (v1) {
                  ...
                  var asCommand = function (v2) {
                      if (v2.position instanceof Data_Maybe.Just && (v2.suggestion instanceof Data_Maybe.Just && contains(v1.range)(LanguageServer_IdePurescript_Build.positionToRange(v2.position.value0)))) {
                          ...
                          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([ LanguageServer_IdePurescript_Commands.replaceSuggestion(IdePurescript_QuickFix.getTitle(v2.errorCode))((function (v3) {
                              return v3.uri;
                  ...
                  if (v2 instanceof Data_Maybe.Just) {
                      return Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Array.concat)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(asCommand)(v2.value0));
                  };
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ]);
              };
          };
          ...
          return function (v) {
              return function (args) {
                  ...
                  if (v.conn instanceof Data_Maybe.Just && args.length === 3) {
                      var $58 = Control_Monad_Except.runExcept(Data_Foreign.readString(args[0]));
                      if ($58 instanceof Data_Either.Right) {
                          var $59 = Control_Monad_Except.runExcept(Data_Foreign.readString(args[1]));
                          if ($59 instanceof Data_Either.Right) {
                              var $60 = Control_Monad_Except.runExcept(readRange(args[2]));
                              if ($60 instanceof Data_Either.Right) {
                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                      var v2 = LanguageServer_DocumentStore.getDocument(docs)($58.value0)();
                                      var v3 = LanguageServer_TextDocument.getVersion(v2)();
                                      var v4 = LanguageServer_TextDocument.getTextAtRange(v2)($60.value0)();
                                      var v5 = LanguageServer_TextDocument.getTextAtRange(v2)(afterEnd($60.value0))();
                                      var trailingNewline = IdePurescript_Regex["test'"](Data_String_Regex.regex("\\n\\s+$")(Data_String_Regex_Flags.noFlags))($59.value0);
                                      var addNewline = trailingNewline && Data_String.length(Data_String.trim(v5)) > 0;
                                      var newText = Data_String.trim($59.value0) + (function () {
                                          if (addNewline) {
                                              return "\x0a";
                                          };
                                          return "";
                                      })();
                                      var edit = IdePurescript_VSCode_Text.makeWorkspaceEdit($58.value0)(v3)($60.value0)(newText);
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var launchAffLog = function ($126) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(function ($127) {
              return logError(IdePurescript_PscIdeServer["Error"].value)(Data_Show.show(Control_Monad_Eff_Exception.showError)($127));
          })(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($126));
      };
      var stopPscIdeServer = Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
          ...
          Control_Monad_Eff_Ref.modifyRef(v)(Data_Newtype.over(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.ServerState)(function (v2) {
              ...
              $50.port = Data_Maybe.Nothing.value;
              $50.deactivate = Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
              return $50;
          }))();
      ...
      var startPscIdeServer = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(function ($128) {
          return (function (v2) {
              return v2.root;
          })(Data_Newtype.unwrap(LanguageServer_IdePurescript_Types.newtypeServerState)($128));
                      ...
                      if (v4.port instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde.load(v4.port.value0)([  ])([  ]))(function (v5) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.modifyRef(v)(Data_Newtype.over(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.ServerState)(function (v6) {
                                  var $57 = {};
                                  for (var $58 in v6) {
                                      if ({}.hasOwnProperty.call(v6, $58)) {
                                          $57[$58] = v6[$58];
                                      };
                                  };
                                  $57.port = new Data_Maybe.Just(v4.port.value0);
                                  $57.deactivate = v4.quit;
                                  return $57;
                              }))))(function () {
      ...
      var v2 = LanguageServer_Setup.initConnection(LanguageServer_IdePurescript_Commands.commands)(function (v2) {
          return function __do() {
              Control_Monad_Eff_Ref.modifyRef(v)(Data_Newtype.over(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.ServerState)(function (v3) {
                  ...
                  $64.root = Data_Nullable.toMaybe(v2.params.rootPath);
                  return $64;
              }))();
      ...
      Control_Monad_Eff_Ref.modifyRef(v)(Data_Newtype.over(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.ServerState)(function (v3) {
          ...
          $71.conn = new Data_Maybe.Just(v2);
          return $71;
      }))();
      LanguageServer_Handlers.onDidChangeConfiguration(v2)(function ($129) {
      ...
      var showModule = function ($130) {
          return (function (v4) {
              return v4.moduleName + Data_Maybe.maybe("")(function (v5) {
                  return " as " + v5;
              })(v4.qualifier);
          })(Data_Newtype.unwrap(IdePurescript_Modules.moduleNewtype)($130));
      };
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(LanguageServer_Uri.uriToFilename(uri)))(function (v6) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.getModulesForFileTemp(v4.port.value0)(v6)(v5))(function (v7) {
                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.modifyRef(v)(Data_Newtype.over(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.ServerState)(function (v8) {
                                  var $83 = {};
                                  for (var $84 in v8) {
                                      if ({}.hasOwnProperty.call(v8, $84)) {
                                          $83[$84] = v8[$84];
                                      };
                                  };
                                  $83.modules = v7;
                                  $83.modulesFile = new Data_Maybe.Just(uri);
                                  return $83;
                              })));
                          });
                      });
      ...
      var getTextDocUri = function ($131) {
      ...
      LanguageServer_DocumentStore.onDidChangeContent(v3)(function (v4) {
          return Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(Control_Monad_Eff_Ref.modifyRef(v)(Data_Newtype.over(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.ServerState)(function (v5) {
              var $91 = {};
              for (var $92 in v5) {
                  if ({}.hasOwnProperty.call(v5, $92)) {
                      $91[$92] = v5[$92];
                  };
              };
              $91.modulesFile = Data_Maybe.Nothing.value;
              return $91;
          })));
      })();
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(LanguageServer_IdePurescript_Build.getDiagnostics(uri)(v5)(v6))(function (v7) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(LanguageServer_Uri.uriToFilename(uri)))(function (v8) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.writeRef(v)(Data_Newtype.over(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.newtypeServerState)(LanguageServer_IdePurescript_Types.ServerState)(function (s1) {
                                  var $99 = {};
                                  for (var $100 in s1) {
                                      if ({}.hasOwnProperty.call(s1, $100)) {
                                          $99[$100] = s1[$100];
                                      };
                                  };
                                  $99.diagnostics = Data_StrMap.insert(Data_Newtype.un(LanguageServer_Types.newtypeDocumentUri)(LanguageServer_Types.DocumentUri)(uri))(v7.pscErrors)(s1.diagnostics);
                                  $99.modulesFile = Data_Maybe.Nothing.value;
                                  return $99;
                              })(v6))))(function () {
      ...
      return LanguageServer_Handlers.onExecuteCommand(v2)(function (v4) {
          return Control_Promise.fromAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v1)))(function (v5) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v)))(function (v6) {
                  ...
                  throw new Error("Failed pattern match at LanguageServer.IdePurescript.Main line 181, column 5 - line 185, column 14: " + [ v7.constructor.name ]);
              });
          }));
      })();
  };
